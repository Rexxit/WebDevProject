...
function makeTable (obj_List, sortOrderPropName, sortIcon) 
{
    ...
    function jsSort(list, byProperty) 
    {
        ...
        list.sort(// takes in one parameter -- a function that compares two elements in the list...
                ...
                function (q, z) 
                {  // in line anonymous fn to compare list elements: 
    ...
    function addTableHead (table, list) 
    {
        ...
        for (var prop in obj) 
        {
            ...
            console.log("current icon is: " + sortIcon);
            ...
            colHead.onclick = function () 
            {
                ...
                // for sort order. 
//                alert("forward "+ this.sortPropName);
//                alert("reverse "+ this.sortPropName);
    ...
    function addTableBody (table, list, sortOrderPropName) 
    {
        ...
        jsSort(obj_List, sortOrderPropName);
    ...
    addTableHead (newTable, obj_List);
    addTableBody (newTable, obj_List, sortOrderPropName);
   ...
   // return newTable;
    ...
    RefreshTableBody(searchInput.value, newTable, obj_List);
