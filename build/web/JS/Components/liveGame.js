...
function liveGame()
{
            ...
            ajax("webAPIs/listGameAPI.jsp", processData, clickSortContainer);
            ...
            function processData(list) 
            {
                ...
                {
                    document.getElement(clickSortContainer).innerHTML = list.dbError;
                    return;
                }
                
                var heading = Utils.make({
                htmlTag: "h2",
                parent: clickSortContainer
              });
                Utils.make({// don't need reference to this span tag...
            htmlTag: "span",
            innerHTML: "Web Game List ",
            parent: heading
        });
        var img = Utils.make({
            htmlTag: "img",
